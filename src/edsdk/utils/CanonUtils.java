...
import edsdk.a.EdsDirectoryItemInfo;
...
public class CanonUtils {
    ...
    /**
     * Converts a bunch of bytes to a string. This is a little different from
     * new String( myBytes ) because byte-arrays received from C will be crazy
     * long and just have a null-terminator somewhere in the middle.
     */
     ...
     * file. Can also be null or a directory. In case of null the temp directory
     * will be used, in case of a directory the file name of the item will be
     * used.
     * @param deleteAfterDownload Should the image be deleted right after
     * successful download
